...
{
    m_pInstance->AddEntity("Minecraft\\fence_long.obj", "fence_pen_0", (uint)EntityTypes::Fence);
    ...
    m_pInstance->AddEntity("Minecraft\\fence.obj", "fence_pen_6", (uint)EntityTypes::Fence);
