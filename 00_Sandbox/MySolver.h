...
namespace Simplex
{
	...
	public:
		...
		*/
		...
		/*
		USAGE: Sets the value of m_bIsColliding
		ARGUMENTS: bool a_bIsColliding -> Sets the colliding value
		OUTPUT: ---
		*/
		void SetIsColliding(bool a_bIsColliding = true);
